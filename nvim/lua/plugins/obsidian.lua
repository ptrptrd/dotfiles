return {
  ...
  lazy = true,
  event = { "BufReadPre /home/ptrd/Obsidian/my-vault/**.md" },
  ...
  opts = {
    dir = "~/Obsidian/my-vault",  -- no need to call 'vim.fn.expand' here
  ...
  config = function(_, opts)
	...
	keys = {
		...
		{'<leader>fo', '<cmd>ObsidianSearch<cr>', mode = 'n', desc = '[F]ind [O]bsidian Notes'},
		{'<leader>ol', '<cmd>ObsidianLink<cr>', mode = 'n', desc = '[O]bsidian [L]ink' },
		{'<leader>oc', '<cmd>ObsidianLinkNew<cr>', mode = 'n', desc = '[O]bsidian [C]reate New Link'},
	}
}
